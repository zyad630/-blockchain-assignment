...
const { createWorkflowConnection } = require('@/lib/workflow-service');
const { validateRequestBody, createWorkflowConnectionSchema } = require('@/lib/validation-schemas');
...
async function POST(request, { params }) {
  ...
  try {
    ...
    logger.error(
      'Error in POST /api/admin/workflows/templates/[id]/connections',
      {},
      error ,
    );
